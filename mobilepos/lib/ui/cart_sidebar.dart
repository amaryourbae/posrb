    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          value: state.selectedSalesType?.id,
          isExpanded: true,
          icon: Icon(
              ...
              .map(
                (type) => DropdownMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        type.slug.contains('go_food') ||
                                type.slug.contains('gofood')
                            ? LucideIcons.bike
                            : (type.slug.contains('dine_in')
          ...
          onChanged: (String? newValue) {
            if (newValue != null) {
              final type = state.salesTypes.firstWhere((t) => t.id == newValue);
              notifier.setSalesType(type);
            }
          },
        ),
      ),
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        flex: 1,
                        child: ElevatedButton(
                          onPressed: state.cart.isEmpty ? null : onSplitBill,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.white,
