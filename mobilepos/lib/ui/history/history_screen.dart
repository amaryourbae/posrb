          ...
          Row(
            children: [
              ...
              Expanded(
                child: Column(
                  children: [
                    // Header (Search & Date) -> Modified to remove Title/Back since PosLayout handles it
                    Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      if (state.startDate != null &&
                                        ...
                                        Text(
                                          '${AppDateFormatter.formatDate(state.startDate!)} - ${AppDateFormatter.formatDate(state.endDate!)}',
                                          style: TextStyle(
                                            fontSize: 12,
