...
class _InventoryScreenState extends ConsumerState<InventoryScreen> {
  ...
  Future<void> _showStockInputDialog() async {
    final controller = TextEditingController(text: _currentStock.toStringAsFixed(0));
    final newStock = await showDialog<double>(
      context: context,
      builder: (context) {
        return AlertDialog(
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
          title: const Text('Input Stock Manual', style: TextStyle(fontWeight: FontWeight.bold)),
          content: TextField(
  ...
  Widget _buildInventoryCard(Product item) {
    ...
    final isLowStock = item.lowStock == true;
    final isOutOfStock = !item.hasRecipe && item.currentStock <= 0;
  ...
  Widget _buildStatusBadge(bool isOutOfStock, bool isLowStock, bool hasRecipe) {
    String text;
    Color color;
    Color textColor;
    ...
    if (isOutOfStock) {
      ...
      text = hasRecipe ? 'Low Ingredients' : 'Low Stock';
