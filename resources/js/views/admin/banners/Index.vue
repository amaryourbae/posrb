                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                         ...
                         <div>
                             ...
                             <input v-model="form.action_link" placeholder="e.g. /promo" type="text" class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all">
                        </div>
                    </div>
