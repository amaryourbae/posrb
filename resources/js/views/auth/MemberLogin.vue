...
<div class="font-display text-slate-900 pb-6 overflow-x-hidden selection:bg-primary selection:text-white flex flex-col justify-between h-full min-h-[calc(100vh-2rem)]">
    <header class="flex items-center justify-between p-4 sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-gray-100">
        <button @click="$router.push('/app')" class="flex items-center justify-center h-10 w-10 rounded-full hover:bg-gray-100 transition-colors -ml-2 text-slate-800">
    ...
    <div class="px-6 pb-10 text-center space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <button class="flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors">
        ...
        <p class="text-sm text-slate-500">
            Belum punya akun? 
            <router-link to="/app/register" class="font-bold text-primary hover:text-primary-dark underline decoration-2 decoration-transparent hover:decoration-primary transition-all">
                Daftar Sekarang
            </router-link>
        </p>
    </div>
